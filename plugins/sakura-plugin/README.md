...
- `#发红包 金额 个数 [拼手气|均等] [祝福语]`（钓鱼 Lv.5 开放，与转账同一门槛）：总额 10～100000 樱花币、1～20 个，不写模式默认拼手气，关键字与祝福语的位置不限。发红包当场从余额扣款托管，同一个人最多同时挂 3 个未领完的红包。主人不受等级限制，且红包里的樱花币一律凭空产生，不扣主人余额、不记支出流水，过期未领完的份额直接作废而非退回。
