...
export const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "转账", command: "#转账 <数量> @用户", desc: "签到 Lv.4 后可向其他用户转账樱花币。", costNote: "需签到 Lv.4；转账金额" },
      { name: "发红包", command: "#发红包 <金额> <个数> [均等|拼手气] [祝福语]", desc: "签到 Lv.4 后可发红包；金额和个数都必填。", costNote: "需签到 Lv.4；本金加手续费" },
