...
export const menuGroups = [
  ...
  },
  {
    ...
    items: [
      { name: "钓鱼", command: "#钓鱼", desc: "进行一次钓鱼；装备首领鱼饵时挑战当前钓点首领。", costNote: "受装备/道具影响" },
      ...
      { name: "鱼塘天气", command: "#鱼塘天气", desc: "查看当前与下一小时的鱼塘天气，部分鱼类只在特定天气出没。" },
      ...
      { name: "开宝箱", command: "#开宝箱 [宝箱名]", desc: "开启钓点宝箱；每种宝箱都有5%概率开出首领鱼饵。", costNote: "消耗宝箱" },
